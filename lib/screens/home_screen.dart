  ...
  final List<Map<String, String>> servicesData = [
    {
      ...
      'description': 'Professional Haircut - Classic & Modern Styles'
    },
    {
      'image': 'assets/images/shaving.jpg',
      'description': 'Premium Shaving - Smooth & Clean Look'
    },
    {
      'image': 'assets/images/beard_trim.jpg',
      'description': 'Beard Trim - Shape & Define Your Style'
    },
    {
      'image': 'assets/images/hair_coloring.jpg',
      'description': 'Hair Coloring - Vibrant & Natural Tones'
    },
    {
      'image': 'assets/images/massage.jpg',
      'description': 'Relaxing Head Massage - Refresh & Rejuvenate'
    },
  ];
    ...
    return Scaffold(
          ...
          children: [
            ...
            Container(
              ...
              child: GridView.count(
                ...
                mainAxisSpacing: 16,
                children: [
                  menuItem('Services', Icons.cut, Colors.blue, () {
                  ...
                  menuItem('Offers', Icons.local_offer, Colors.red, () {
                    // Tambahkan navigasi ke halaman Offers
                  }),
                  menuItem('Contact Us', Icons.phone, Colors.purple, () {
                    // Tambahkan navigasi ke halaman Contact
                  }),
                  menuItem('Appointments', Icons.calendar_today, Colors.green,
                      () {
                    // Tambahkan navigasi ke halaman Appointments
                  }),
                ],
              ),
            ),
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        onTap: (index) {
          if (index == 0) {
            Navigator.pushNamed(
                context, '/explore'); // Tambahkan navigasi ke Services
          } else if (index == 2) {
            Navigator.pushNamed(
